...
<button
  type="submit"
  className="w-full px-6 py-3 bg-gradient-to-r from-star-light to-blue-500 text-star-dark font-medium rounded-lg
             hover:shadow-lg hover:scale-105 hover:text-white transition-all duration-300 ease-in-out"
>
  Send Message
</button>
    ...
    return (
        <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-star-blue to-star-dark text-white">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="hidden md:grid md:grid-cols-2 gap-12 reveal">
                    <ContactInfoCard />
                    <ContactFormCard />
                </div>
